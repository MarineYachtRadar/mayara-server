...
- **locator:** survive a burst of address changes (#697) ([PR #697](https://github.com/MarineYachtRadar/mayara-server/pull/697))
- **locator:** skip VPN tunnels on every platform (#698) ([PR #698](https://github.com/MarineYachtRadar/mayara-server/pull/698))
...
- **windows:** detect wireless and unusable interfaces correctly (#617) ([PR #617](https://github.com/MarineYachtRadar/mayara-server/pull/617))
- **windows:** keep the OVERLAPPED alive and re-arm address changes (#618) ([PR #618](https://github.com/MarineYachtRadar/mayara-server/pull/618))
...
- **telemetry:** ask once, then report that this install works (#587) ([PR #587](https://github.com/MarineYachtRadar/mayara-server/pull/587))
...
- **gui:** repair the merge that broke the discovery page (#591) ([PR #591](https://github.com/MarineYachtRadar/mayara-server/pull/591))
...
- **gui:** serve radar setup guides from Mayara itself (#562) ([PR #562](https://github.com/MarineYachtRadar/mayara-server/pull/562))
...
- **web:** make /quit stop the whole server (#489) ([PR #489](https://github.com/MarineYachtRadar/mayara-server/pull/489))
...
- **raymarine:** log the whole RD status datagram (#481) ([PR #481](https://github.com/MarineYachtRadar/mayara-server/pull/481))
...
[3.13.2]: https://github.com/MarineYachtRadar/mayara-server/compare/v3.13.1...v3.13.2
...
[3.8.1]: https://github.com/MarineYachtRadar/mayara-server/compare/v3.8.0...v3.8.1
[3.8.0]: https://github.com/MarineYachtRadar/mayara-server/compare/v3.7.0...v3.8.0
