...
fn main() {
    ...
    // the single api-version source, and committed rather than ignored: api.js
    // imports it, and dev/check-gui-modules.mjs resolves that import from a bare
    // checkout, where no build has run.
